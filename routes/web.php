...
Route::get('/goodies/product/show' , [ProductController::class , 'show'])->name('product-show');


Route::group(['middleware' => 'auth'], function () {
    Route::get("/logout", [AuthController::class, "logout"])->name("logout");
    Route::post('/goodies/product/add-to-cart', [CartController::class, 'store'])->name('add-to-cart');
});